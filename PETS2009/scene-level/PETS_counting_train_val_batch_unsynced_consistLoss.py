...
from datagen_v3_unsynced_consistLoss import datagen_v3
...
def main(exp_name='FCNN', verbosity=0):
    ...
    image_shuffle = True
    patch_shuffle = True
    epoch_random_state = None
    # Set this to an integer if you want the data the same in every epoch
    ...
    train_GP_1 = train_path0 + 'GP_maps/PETS_S1L3_1_groundplane_dmaps_10.h5'
    train_GP_2 = train_path0 + 'GP_maps/PETS_S1L3_2_groundplane_dmaps_10.h5'
    train_GP_3 = train_path0 + 'GP_maps/PETS_S2L2_1_groundplane_dmaps_10.h5'
    train_GP_4 = train_path0 + 'GP_maps/PETS_S2L3_1_groundplane_dmaps_10.h5'
    ...
    # the ground-plane GT is corresponding to the view 1 timepoints in 'dataset/dmaps/.../GP_maps/';
    # if not, use ground-plane GT in 'dataset/unsynced_GP_maps/'
    test_GP_1 = train_path0 + 'GP_maps/PETS_S1L1_1_groundplane_dmaps_10.h5'
    test_GP_2 = train_path0 + 'GP_maps/PETS_S1L1_2_groundplane_dmaps_10.h5'
    test_GP_3 = train_path0 + 'GP_maps/PETS_S1L2_1_groundplane_dmaps_10.h5'
    test_GP_4 = train_path0 + 'GP_maps/PETS_S1L2_2_groundplane_dmaps_10.h5'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "-e", "--exp_name",
        type=str,
        default='models/PETS_unsynced_consistLoss',
        action="store")
    parser.add_argument(
        "-v", "--verbosity",
        type=int,
