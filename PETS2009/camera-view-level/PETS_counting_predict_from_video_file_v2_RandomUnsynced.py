...
def main(exp_name):
    ...
    model_name = '02-23.7028-better.h5'
    counting_results_name = 'counting_results/PETS_moreSupervised_fusion_sync_syncloss2/' + model_name
    ...
    model = build_model_load_weights(image_dim=(288, 384, 1),
                                     model_dir='models/PETS_moreSupervised_fusion_sync_syncloss2/',
