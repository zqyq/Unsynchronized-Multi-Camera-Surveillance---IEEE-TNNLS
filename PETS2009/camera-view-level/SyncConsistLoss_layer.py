...
class SyncConsistLoss_layer(Layer):
    ...
    def __init__(self,
        ...
        # self.size = size
        #self.view = view
        super(SyncConsistLoss_layer, self).__init__(**kwargs)


    def build(self, input_shape):
        super(SyncConsistLoss_layer, self).build(input_shape)  # Be sure to call this at the end
    ...
    def call(self, x):
        ...
        #feature_ReduceSumed = tf.reduce_sum(x, axis=-1)

        fusion_v1_proj, fusion_v2_proj = x[0], x[1]
        loss = keras.losses.mean_squared_error(fusion_v1_proj, fusion_v2_proj)
        # loss = 1 - loss
