...
def main(exp_name='FCNN', verbosity=0):
    ...
    # use 2d counting pretrained feature extraction net first,
    # then train the multi-view counting and synchronization part.
    ...
    # random unsynced frames
    train_view2_1_u = train_path0 + 'unsynced_images_h5/timeshift_random_3s/train/Street_train_view2_gray_images_random.h5'
    train_view3_1_u = train_path0 + 'unsynced_images_h5/timeshift_random_3s/train/Street_train_view3_gray_images_random.h5'

    # the ground-plane GT is corresponding to the view 1 timepoints in 'dataset/GP_maps/';
    ...
    train_gen = datagen_v3(
        ...
        h5file_view2_u=h5file_train_view2_u,
        h5file_view3_u=h5file_train_view3_u,
    ...
    test_view2_1_u = train_path0 + 'unsynced_images_h5/timeshift_random_3s/test/Street_test_view2_gray_images_random.h5'
    test_view3_1_u = train_path0 + 'unsynced_images_h5/timeshift_random_3s/test/Street_test_view3_gray_images_random.h5'
    ...
    val_gen = datagen_v3(
        ...
        h5file_view2_u=h5file_test_view2_u,
        h5file_view3_u=h5file_test_view3_u,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "-e", "--exp_name",
        type=str,
        default='models/Street_randomUnsynced_3views_sync_fusion_syncloss',
        action="store")
    parser.add_argument(
        "-v", "--verbosity",
        type=int,
