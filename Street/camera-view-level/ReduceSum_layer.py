...
class ReduceSum_layer(Layer):
    ...
    def __init__(self,
        ...
        # self.size = size
        #self.view = view
        super(ReduceSum_layer, self).__init__(**kwargs)


    def build(self, input_shape):
        super(ReduceSum_layer, self).build(input_shape)  # Be sure to call this at the end
    ...
    def call(self, x):
        ...
        loss = keras.losses.cosine_proximity(fusion_v1_proj, fusion_v2_proj)
        loss = 1 - loss
